...
function showFatalError(err) {
  ...
  // Ambil baris pertama stack trace (nama file & nomor baris) supaya
  // kalau error muncul lagi, penyebabnya langsung kelihatan dari
  // screenshot saja, tanpa perlu buka DevTools.
...
function drawPreview(matched) {
  ...
  if (target) target.innerHTML = `<table class="mos">${thead}${tbody}</table>`;
}
